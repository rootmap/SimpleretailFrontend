...
<head>
<title>Cash Register Software | Simple Retail POS</title>
...
<figure class="figure-fullwidth"> <img src="https://www.simpleretailpos.com/upload/retail_image/simpleretailpos-cash-regist.png" alt="simpleretailpos" width="620" height="465">
</figure>
</div>
</div>
</div>
...
<figure class="figure-fullwidth"> <img src="https://www.simpleretailpos.com/upload/retail_image/backup-reports.png" alt="simpleretailpos" width="620" height="465">
</figure>
</div>
...
<div class="col-md-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.10s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInRight;">
<figure class="figure-fullwidth"> <img src="https://www.simpleretailpos.com/upload/retail_image/tour-guide-simpleretailpos.png" alt="simpleretailpos" width="620" height="465">
</figure>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
<figure class="figure-fullwidth"> <img src="https://www.simpleretailpos.com/upload/retail_image/simple-cash-register.png" alt="simpleretailpos" width="620" height="465">
</figure>
</div>
<div class="col-md-6 col-lg-6 col-xl-6 wow fadeInDown text-left" data-wow-duration="1s" data-wow-delay="0.10s" style="padding:35px; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInDown;">
<h2>Why Should You Prefer Web Cash Register Offered by Simple Retail POS?</h2>
