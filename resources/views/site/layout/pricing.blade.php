            ...
            <div class="container w-container">
               <div>
                  <div class="w-row">
                     ...
                     <?php
                     $fotterSeoLinkCount=count($fotterSeoLink);
                     ?>
                     @if($fotterSeoLinkCount>0)
                        <?php 
                        $i=1;
                        ?>
                        @foreach($fotterSeoLink as $fot)
                          <?php 
                          if($i==1)
                          {
                            ?>
                            <div class="w-col w-col-3 w-col-stack wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.10s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s;">
                              <div class="footer-title"></div>
                              <div class="">
                            <?php
                          }
                          ?>
                            ...
                            <a href="{{$fot->link}}" class="footer-block w-inline-block w--current">
                              <div class="footer-link normal">{{$fot->name}}</div>
                           </a>

                          <?php 
                          if($i==$fotterSeoLinkCount)
                          {
                              ?>
                                        </div>
                               </div>
                          ...
                          elseif($i==10 && $i!=$fotterSeoLinkCount)
                          {
                              ?>
                                        </div>
                               </div>
